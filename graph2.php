...
DateTime BETWEEN '$date1' AND '$date2:59'" . $SQLScale;   
  ...
  if (((abs(floatval($Tepl_TV_prev) - floatval($row["T_TV"]))) > floatval($sens)) ||
    ...
    {
        // Mel bych podle velikosti $scale projit pole tolikrat, kolikrat je potreba
        // z toho spocitat prumer a ten predat
        
        if if ($scale == "10")  // beru prumer z dvou hodnot
        {
